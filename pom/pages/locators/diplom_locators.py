...
# drag_and_drop_example = (By.CSS_SELECTOR, '#content > ul > li:nth-child(10) > a')
# a_example = (By.CSS_SELECTOR, '#column-a')
# b_example = (By.CSS_SELECTOR, '#column-b')
...
code_200 = (By.CSS_SELECTOR, '//*[@id="content"]/div/ul/li[1]/a')
# code_200_example = (By.CSS_SELECTOR, '#content > div > ul > li:nth-child(1) > a')
# status_code_example = (By.CSS_SELECTOR, '#content > ul > li:nth-child(42) > a')
